    ...
    <DashboardLayout>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-foreground">Integrações & Relatórios</h1>
            <p className="text-muted-foreground">Gerencie integrações externas e exporte relatórios</p>
          </div>
        </div>
        ...
        {activeTab === 'integrations' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-medium text-foreground">Integrações Disponíveis</h2>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {integrations.map((integration) => (
                <div key={integration.id} className="bg-card rounded-lg border border-muted p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center">
                      {getIntegrationIcon(integration.type)}
                      <h3 className="ml-2 text-lg font-medium text-foreground">{integration.name}</h3>
                    </div>
                    <div className="flex items-center">
                      {integration.enabled ? (
        ...
        {activeTab === 'reports' && (
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-medium text-foreground">Exportar Relatórios</h2>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={reportType.type} className="bg-card rounded-lg border border-muted p-6">
                  <div className="flex items-center mb-4">
                    {getReportIcon(reportType.type)}
                    <h3 className="ml-2 text-lg font-medium text-foreground">{reportType.name}</h3>
                  </div>
                  
                  <p className="text-muted-foreground text-sm mb-4">{reportType.description}</p>
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-3 py-1 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-card hover:bg-card"
                  >
            ...
            {reports.length > 0 && (
              <div>
                <h3 className="text-lg font-medium text-foreground mb-4">Relatórios Gerados</h3>
        ...
        {showExportModal && (
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-card">
              <div className="mt-3">
                <h3 className="text-lg font-medium text-foreground mb-4">Exportar Relatório</h3>
